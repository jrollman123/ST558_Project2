...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-5-1.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-6-2.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-6-3.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-6-4.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-7-1.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-7-2.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-7-3.png)
...
![](ST558_Project2_files/figure-markdown_github/unnamed-chunk-8-1.png)
...
```
    ...
    ##                                  RMSE  Rsquared
    ## Single Regression Tree Model 1595.694 0.2955464
...
```
    ...
    ##                        RMSE  Rsquared
    ## Boosted Tree Model 1377.977 0.5618682
...
|                              |     RMSE|  Rsquared|
|:-----------------------------|--------:|---------:|
| Single Regression Tree Model |  1595.69|      0.30|
| Boosted Tree Model           |  1377.98|      0.56|
...
|                              |     RMSE|  Rsquared|
|:-----------------------------|--------:|---------:|
| Single Regression Tree Model |   960.82|      0.65|
| Boosted Tree Model           |  1135.98|      0.51|

Based on the testing data performance, Single Regression Tree Model would be the more optimal model based on test RMSE. This could also be affected by the stochastic nature of splitting the data set into a test and training set. Further work could be done to make sure both test and training set are equally representative.
